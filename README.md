...
- `Intent-based Supervisor Routing`
- `Real-time Booking & Rescheduling`
...
`Python` • `LangGraph` • `LangChain` • `Grok-4 (xAI)` • `Pandas` • `Pydantic`
...
- AI/Agentic workflows using LangGraph and LangChain
